...
class ShoulderViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseHandle = ref?.child("shoulders").observe(.childAdded, with: { (snapshot) in
