...
class AbsExercisesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseHandle = ref?.child("abs").observe(.childAdded, with: { (snapshot) in
