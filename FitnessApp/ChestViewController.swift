...
class ChestViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseHandle = ref?.child("chest").observe(.childAdded, with: { (snapshot) in
